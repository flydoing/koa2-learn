...
export default {
  components: {
    ...
    Overlay: resolve => require(['@/components/Overlay'], resolve),
    ...
    ModelPage: resolve => require(['@/views/components/page/Index'], resolve),
    MenuPage: resolve => require(['@/views/components/page/Default'], resolve),
    Page: resolve => require(['@/views/components/page/Page'], resolve),
    AppPage: resolve => require(['@/views/components/page/Page'], resolve),
    Popover: resolve => require(['@/views/components/page/Popover'], resolve),

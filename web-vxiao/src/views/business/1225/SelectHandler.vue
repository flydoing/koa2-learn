  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        Api.tacitlyApprove(1225, this.groupId).then(res => {
      ...
      handleAdd(type, order) {
        ...
        this.setScrapping(params)
        this.routePush({ name: 'selectMember1225' })
      }
    }
  }
</script>

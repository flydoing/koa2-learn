  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        Api.tacitlyApprove(1211, this.groupId).then(res => {
      ...
      handleAdd(type, order) {
        ...
        this.setGiveBack(params)
        this.routePush({ name: 'selectMember1211' })
      }
    }
  }
</script>

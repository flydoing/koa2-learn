<template>
  <Setup appType="'1073'">
    <!-- <template v-if="isClass && (isSuperAdmin || isAdmin || isAppAdmin('1073'))" slot="others">
    ...
    <template v-if="isSchool && (isSuperAdmin || isAdmin || isAppAdmin('1073'))"
              slot="others">

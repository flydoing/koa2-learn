  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        Api.tacitlyApprove(1238, this.groupId).then(res => {
      ...
      handleAdd(type, order) {
        ...
        this.setProcurement(params)
        this.routePush({ name: 'selectMember1238' })
      }
    }
  }
</script>

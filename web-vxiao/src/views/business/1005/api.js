...
export default {
  ...
  commitMedalData(data) {
    return http.post('/business/evaluation/add/category.json', data)
  },
  ...
  loadRadarData(params) {
    let url = `/business/evaluation/query/randar/${params.groupId}?timeType=${params.timeType}&startTime=${params.startTime}&endTime=${params.endTime}`
    if (params.userId) {

        ...
        if (this.activated === 1) {
          ...
          if (this.pwdBlur() && this.confirmPwdBlur()) {
            ...
            Api.forgetPwd({
              ...
              validate: {
                mobile: this.isMobile ? this.mobile : this.parentMobile,
                vcode: this.sms,
                newPwd: this.pwd
              }
            })

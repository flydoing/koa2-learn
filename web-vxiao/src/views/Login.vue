      ...
      <div class="header-box">
        <a class="header-logo">
          <img class="header-logo-img"
               src="https://www.vxiao.cn/img/vxiao_ico.png">
          <div class="header-logo-text">V校 更智慧的学校</div>
        </a>
        <div class="header-nav">
          ...
          <a href="https://apps.apple.com/cn/app/v%E6%A0%A1/id1197926370?mt=12">Mac</a>
    ...
    data() {
      return {
        ...
        lines: [
          ...
          { content: '教育不是灌输，而是点燃心灵的火焰。', author: '——苏格拉底' },
          ...
          { content: '未来的文盲不再是不识字的人，而是没有学会怎样学习的人。', author: '——埃德加·富尔（联合国教科文组织国际教育发展委员会前主席）' },
          ...
          {
            content:
              '生而好学为上，熏染而学次之，督促而学以次之，最下者虽督促不学。然而生而好学与督促不学的人究竟是少数，大多数得到相当熏染、督促就学习。',
            author: '——陶行知'
          },
          { content: '唯宽可以容人，唯厚可以载物。', author: '——薛宣（明代）' },
          ...
          { content: '没有比成功更能增加满足的感觉，也没有比成功更能鼓起进一步成功的努力。', author: '——盖兹（心理学家）' },
          { content: '时时要让孩子知道，我们爱他们，大家喜欢他们，是因为他们的品德，与他们的成绩单没有任何关系。', author: '—第威夫人（美国）' },
          ...
          { content: '如果把错误关在门外，真理也将关在门外。', author: '——泰戈尔' },
          { content: '称为英雄的，并非以思想或强力称雄的人；而只是靠心灵而伟大的人。', author: '——罗曼·罗兰' },
          { content: '成功的教师之所以成功，是因为他把课教活了。', author: '——吕叔湘' },
          ...
          {
            content: '如果每一个孩子都学会了赏识自己，都找到了自己是一个好学生的感觉，都有了自信和创造的尊严，那么，他们将获得终身享用不尽的真正财富。',
            author: '——窦桂梅（清华附小校长）'
          },
          { content: '把简单的事情做好就是不简单。', author: '——张瑞敏（海尔）' },
          { content: '人类本质中最殷切的要求是：渴望被肯定。', author: '——詹姆士（哲学家）' },
          ...
          { content: '真正的对话，是从一个开放心灵到另一个开放心灵之话语。马丁·布伯（德国）' },
          ...
          { content: '世界上最可怕的两个词，一个叫认真，一个叫执着。认真的人改变自己，执着的人改变命运。' },
          ...
          { content: '教育是什么，往简单方面说，只需一句话，就是养成良好的习惯。', author: '——叶圣陶' },
          {
          ...
          { content: '我以为好的先生不是教书，不是教学生，乃是教学生学。', author: '——陶行知' },
          { content: '学习任何知识的最佳途径是由自己去发现，因为这种发现理解最深、也最容易掌握其中的规律、性质和联系。', author: '——波莉亚' },
          { content: '有首先看到学生优点的地方，学生才能产生上进心。', author: '——苏霍姆林斯基' },
          { content: '你的教鞭下有瓦特，你的冷眼里有牛顿，你的讥笑中有爱迪生。', author: '——陶行知' },
          ...
          { content: '差的老师上课会叙述，一般的老师上课会讲解，良好的老师会提问，优秀老师重在启发，杰出的老师让课堂开放。', author: '——杜郎口中学' },
